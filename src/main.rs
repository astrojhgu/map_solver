...
fn main() {
    ...
    for _i in 0..1 {
        ...
        RawMM::from_array1(ArrayView1::from(&gx)).to_file("gx.mtx");
        RawMM::from_array1(ArrayView1::from(&gp)).to_file("gp.mtx");
        RawMM::from_array1(ArrayView1::from(&dx)).to_file("dx.mtx");
        RawMM::from_array1(ArrayView1::from(&dp)).to_file("dp.mtx");
